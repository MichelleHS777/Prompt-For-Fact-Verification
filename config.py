...
def set_args():
    ...
    parser.add_argument('--train_file', type=str, default='datasets/unpreprocess/train.json', help='train dataset path')
    parser.add_argument('--fake_train_file', type=str, default='datasets/preprocessed/fake.json', help='fake nei dataset for training')
    parser.add_argument('--valid_file', type=str, default='datasets/unpreprocess/dev.json', help='validation dataset path')
    parser.add_argument('--test_file', type=str, default='datasets/unpreprocess/test.json', help='test dataset path')
    parser.add_argument('--plm', type=str, default='bert', help='bert, roberta')
