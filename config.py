...
def set_args():
    ...
    parser.add_argument("--template", type=int,
                        help="Set template (0 for manual, 1 for Ptuning (soft APE), 2 for Ptuning (soft: 10 + APE), 3 for PTuning (soft: 10))",
                        default=0)
    parser.add_argument("--verbalizer", type=int, help="Set manual template", default=0)
