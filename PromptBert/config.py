...
def set_args():
    ...
    parser.add_argument('--train_data_path', default='../datasets/evidence extraction/train.data', type=str, help='训练数据集')
    parser.add_argument('--dev_data_path', default='../datasets/evidence extraction/test.data', type=str, help='测试数据集')
