...
def set_args():
    ...
    parser.add_argument('--train_data_path', default='./data/CHEF/train.data', type=str, help='训练数据集')
    parser.add_argument('--dev_data_path', default='./data/CHEF/test_evidence.json', type=str, help='测试数据集')
    ...
    parser.add_argument('--save_file', default='result/0311/test_result.jsonl', type=str, help='save file path')
